...
TEST_F(MLASTTest, TestIntExpToString) {
    IntExp int_exp = -1;
    auto exp = std::make_shared<Exp>(int_exp);
...
TEST_F(MLASTTest, TestBoolExpToString) {
    ...
    auto exp = std::make_shared<Exp>(bool_exp);
...
TEST_F(MLASTTest, TestPlusOpExpToString) {
    ...
    auto exp_left = std::make_shared<Exp>(int_exp_left);

    IntExp int_exp_right = 0;
    auto exp_right = std::make_shared<Exp>(int_exp_right);

    auto op_exp = std::make_shared<OpExp>(exp_left, Plus(), exp_right);
    auto exp = std::make_shared<Exp>(op_exp);
...
TEST_F(MLASTTest, TestMinusOpExpToString) {
    ...
    auto op_exp = std::make_shared<OpExp>(exp_left, Minus(), exp_right);
    auto exp = std::make_shared<Exp>(op_exp);
...
TEST_F(MLASTTest, TestTimesOpExpToString) {
    ...
    auto op_exp = std::make_shared<OpExp>(exp_left, Times(), exp_right);
    auto exp = std::make_shared<Exp>(op_exp);
...
TEST_F(MLASTTest, TestLtOpExpToString) {
    ...
    auto op_exp = std::make_shared<OpExp>(exp_left, Lt(), exp_right);
    auto exp = std::make_shared<Exp>(op_exp);
...
TEST_F(MLASTTest, TestIfExpToString) {
    ...
    auto exp_cond = std::make_shared<Exp>(bool_exp_cond);

    IntExp int_exp_true = -11;
    auto exp_true = std::make_shared<Exp>(int_exp_true);

    IntExp int_exp_false = 13;
    auto exp_false = std::make_shared<Exp>(int_exp_false);

    auto if_exp = std::make_shared<IfExp>(exp_cond, exp_true, exp_false);
    auto exp = std::make_shared<Exp>(if_exp);
